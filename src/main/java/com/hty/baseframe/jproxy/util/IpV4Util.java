...
//
    ...
    //192.168.16.1, 192.168.71.1, 192.168.2.200
    //192.168.16.128
    public static void main(String[] args) throws UnknownHostException
    {
        ...
        System.out.println(getIpV4Value("192.168.2.200"));
        System.out.println(getIpV4Value("192.168.16.100"));
        System.out.println(checkSameSegment("192.168.16.111", "192.168.16.128", -1062727580));
